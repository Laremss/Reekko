...
interface FooterProps {
  ...
  ressourcesLinks?: Array<{ href: string; label: string }>
  copyrightText?: string
  legalLinksHref?: string
  legalLinksLabel?: string
  privacyLinksHref?: string
...
export default function Footer(props: FooterProps = {}) {
  const {
    ...
    privacyLinksHref,
    privacyLinksLabel,
  } = { ...FOOTER_DEFAULTS, ...props }

  const currentYear = new Date().getFullYear()
  const footerLinks = { navigation: navigationLinks, ressources: ressourcesLinks }
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-5 group w-fit">
              ...
              <span className="font-bold text-white text-xl tracking-tight">{brandName}</span>
            </Link>
