...
Le marketing traditionnel se concentre souvent sur le haut du funnel (awareness). Le growth marketing adresse toutes les étapes : acquisition, activation, rétention, referral, revenu. Ce framework est connu sous le nom de **[AARRR](/blog/framework-aarrr)** (ou Pirate Metrics).
...
Le framework AARRR, créé par Dave McClure, est le cœur du growth marketing. Il décompose le parcours client en 5 étapes. Pour une analyse complète de chaque étape avec les métriques associées, consultez notre [guide dédié au framework AARRR](/blog/framework-aarrr).
...
- [Le framework AARRR : guide complet des Pirate Metrics](/blog/framework-aarrr)
- [Growth loops : la stratégie de croissance auto-alimentée](/blog/growth-loops-b2b)
