...
const comparison = [
  {
    before: 'Prospection manuelle, chronophage et aléatoire',
    after: 'Séquences automatisées, actives 24h/24',
  },
  {
    before: 'Pipeline imprévisible, dépendant de votre énergie',
    after: 'Flux de leads prévisible dès la semaine 3',
  },
  {
    before: 'Scalabilité limitée sans recruter',
    after: 'Scalable sans effort supplémentaire',
  },
  {
    before: 'Coûts d\'acquisition difficiles à piloter',
    after: 'ROI tracé en temps réel, optimisé en continu',
  },
]
